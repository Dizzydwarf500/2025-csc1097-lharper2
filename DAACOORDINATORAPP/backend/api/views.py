...
def analyze_shifts(request):
    try:
        ...
        prompt = (
            ...
            "⏳ All staff below have an 'Ideal Break Window' listed. Choose both breaks **inside that window**, "
            ...
            "🧾 Return only the people you've assigned break times to, in this exact format:\n"
